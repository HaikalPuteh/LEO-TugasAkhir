 ...
 * @returns {{ra: number, dec: number}} Object with Right Ascension (ra) and Declination (dec) in radians.
 */
 ...
 *
 * @param {number} d - Days since J2000 epoch (d = toJulian(date) - 2451545).
 * @param {number} lw - Longitude west in degrees (0 for Greenwich). Note: This parameter is typically 0 for GMST.
...
function siderealTime(d, lw) {
    ...
    return degToRad((gmst * 15 + lw) % 360); 
}
