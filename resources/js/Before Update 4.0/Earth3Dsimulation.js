...
function init3DScene() {
    ...
    const earthDayMap = textureLoader.load("/textures/Earth_Map.jpg");
...
function loadGlobalGLBModel() {
    ...
    return new Promise((resolve, reject) => {
        gltfLoader.load(
            'https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Models/master/2.0/Box/glTF-Binary/Box.glb', // Using a simple GLB model for demonstration. Replace with your actual model path.
            (gltf) => {
