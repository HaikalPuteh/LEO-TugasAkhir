...
function draw2D() {
    ...
    if(sub.latitude>=0) { tctx.lineTo(canvas.width,canvas.height); tctx.lineTo(0,canvas.height); }
    else               { tctx.lineTo(canvas.width,0);           tctx.lineTo(0,0);           }
