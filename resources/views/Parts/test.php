...
function updateSatelliteDataDisplay() {
    ...
    if (selectedSat && selectedSat.mesh && selectedSat.mesh.position && selectedSat.params) {
        ...
        if (document.getElementById("dataLatitude")) document.getElementById("dataLatitude").innerText = selectedSat.latitudeDeg ? selectedSat.latitudeDeg.toFixed(2) : "N/A";
        if (document.getElementById("dataLongitude")) document.getElementById("dataLongitude").innerText = selectedSat.longitudeDeg ? selectedSat.longitudeDeg.toFixed(2) : "N/A";
    ...
    if (hasAnyItems) {
        ...
        fileOutputs.forEach(data => {
            if (data.fileType === 'constellation') {
                ...
                mainButton.className = "satellite-button constellation-toggle btn btn-sm btn-success"; // Using Bootstrap classes
                ...
                memberList.className = "constellation-members-list hidden"; // Initially hidden
                ...
                if (data.satellites && window.activeSatellites) {
                    data.satellites.forEach(satId => {
                        ...
                        if (satelliteObj) {
                            ...
                            subButton.className = "satellite-button btn btn-sm btn-info"; // Using Bootstrap classes
...
window.onload = function() {
    // Remove the reload check to ensure data persists on F5
    ...
    //     groundStations = new Map();
    //     linkBudgetAnalyses = new Map();
    //     // Clear the corresponding localStorage keys
    ...
    // } else {
        // Load data from localStorage for all navigation types
