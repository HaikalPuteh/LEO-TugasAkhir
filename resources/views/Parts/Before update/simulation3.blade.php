...
import { DEG2RAD, EarthRadius, MU_EARTH } from "{{ Vite::asset('resources/js/parametersimulation.js') }}";
       ...
       //-----------------------------------------SideBar ----------------------------------------------------------
        ...
        // Add active class to the button if it exists
        if (btn) {
            btn.classList.add('active');
        } else {
            console.warn(`Button for tab "${id}" not found.`);
        }
        
        // Update satellite list if switching to output-menu and it exists
        if (id === 'output-menu' && tabContent) {
...
// ------------------------------------- END SATELLITE LIST UI FUNCTIONS ------------------------------------
